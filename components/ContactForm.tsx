...
export default function ContactForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#C00707] to-[#FF4400] text-white py-3 px-6 font-semibold hover:from-[#C00707]/90 hover:to-[#FF4400]/90 transform transition-all duration-200 shadow-lg hover:shadow-xl"
            >
                Gửi Tin Nhắn
            </button>
        </form>
