    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className=" animation-delay-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#contact-form" className="bg-white text-[#134E8E] px-8 py-3 font-semibold transition-all duration-200 transform shadow-lg hover:bg-gray-100">
                Gửi Tin Nhắn
              </a>
              <a href="tel:+842838238899" className="border-2 border-white text-white px-8 py-3 font-semibold hover:bg-white hover:text-[#134E8E] transition-all duration-200 transform">
                Gọi Ngay
              </a>
            </div>
          </div>
      ...
      <section
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
          ...
          <div
            ref={contactInfoRef}
            className="space-y-8 opacity-0 transform translate-y-8 transition-all duration-1000 ease-out"
          >
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 transition-all duration-300 transform">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 transition-all duration-300 transform">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 transition-all duration-300 transform">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 transition-all duration-300 transform">
